          ...
          <div className="lg:grid lg:grid-cols-2">
            ...
            <form>
              ...
              <div className="grid grid-cols-2 justify-center mt-[24px] p-[4px] lg:mt-[24px] lg:p-[4px] rounded-[6px] bg-[#F5F5F5]">
                <Link href="/login" className="w-full text-base text-center font-bold text-primary bg-white py-[10px] rounded-md px-8">Sign In</Link>
                <Link href="/register" className="w-full text-base text-center font-bold text-[#808080] bg-transparent py-[10px] rounded-md px-8">Sign Up</Link>
              </div>
              ...
              <div className="flex flex-wrap mt-5 justify-center">
                <button className="w-full text-[16px] font-poppins font-[600] text-[#171717] border border-1 border-[#171717] bg-white py-[10px] rounded-md px-[16px] items-center flex justify-center"><Image className="lg:me-[16px]" width={17} height={17} alt="pointer 1" src="/google.svg"/>Sign Up with Google</button>
              </div>
              </form>
            </div>
          </div>
